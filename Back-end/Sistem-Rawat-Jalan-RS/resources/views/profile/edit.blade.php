                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                value="{{ $petugasMedis->nama_petugas_medis, old('nama_petugas_medis') }}"
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                value="{{ $petugasMedis->nip, old('nip') }}" name="nip">
                                            @error('nip')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select
                                                ...
                                                @foreach ($jenisKelamins as $jenisKelamin)
                                                    <option value="{{ $jenisKelamin }}" @selected($petugasMedis->jenis_kelamin == $jenisKelamin)>
                                                        {{ $jenisKelamin }}</option>
                                                @endforeach
                                            </select>
                                            @error('jenis_kelamin')
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                value="{{ $petugasMedis->no_hp, old('no_hp') }}" name="no_hp">
                                            @error('no_hp')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control form-control-user @error('alamat') is-invalid @enderror" placeholder="Masukkan Alamat"
                                                rows="3" placeholder="Masukkan alamat" name="alamat">{{ $petugasMedis->alamat, old('alamat') }}</textarea>
                                            @error('alamat')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                placeholder="Masukkan nama"
                                                value="{{ $apoteker->nama_apoteker, old('nama_apoteker') }}"
                                                name="nama_apoteker">
                                            @error('nama_apoteker')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                placeholder="Masukkan Nomor Induk Pegawai"
                                                value="{{ $apoteker->no_sipa, old('no_sipa') }}" name="no_sipa">
                                            @error('no_sipa')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <select
                                                ...
                                                <option value="" selected> -- Pilih -- </option>
                                                @foreach ($jenisKelamins as $jenisKelamin)
                                                    <option value="{{ $jenisKelamin }}" @selected($apoteker->jenis_kelamin == $jenisKelamin)>
                                                        {{ $jenisKelamin }}</option>
                                                @endforeach
                                            </select>
                                            @error('jenis_kelamin')
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                class="form-control form-control-user @error('no_hp') is-invalid @enderror"
                                                placeholder="Masukkan Nomor HP" value="{{ $apoteker->no_hp, old('no_hp') }}"
                                                name="no_hp">
                                            @error('no_hp')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <label class="form-control-label">Alamat</label>
                                            <textarea class="form-control form-control-user @error('alamat') is-invalid @enderror" placeholder="Masukkan Alamat"
                                                rows="3" name="alamat">{{ $apoteker->alamat, old('alamat') }}</textarea>
                                            @error('alamat')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
